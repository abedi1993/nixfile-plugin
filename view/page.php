...
<div class="nixfile-container">
    ...
    <div class="nixfile-media-section">
        <div class="nixfile-detail-bar">
            <img src="https://picsum.photos/450/200" alt="">
            <hr>
            <p id="nixfile-detail-name">image.png</p>
            <p id="nixfile-detail-date">16 خرداد 1404</p>
            <p id="nixfile-detail-size">5 کیلو بایت</p>
            <p id="nixfile-detail-resolution">300 * 200 پیگسل</p>
            <p>اپلود شده در نیکس فایل</p>
            <div class="nixfile-detail-actions">
                <button id="nixfile-detail-link-btn">کپی لینک</button>
                <p id="nixfile-detail-link">l;dkasl;kda;lskdals;dkasdkas;l</p>
            </div>
        </div>
    </div>
